...
const Promo = () => {
    ...
    return (
        <div>
            <Grid container width='450px' height='300px' mx={1} borderRadius='10px' justifyContent="center" sx={{cursor: 'pointer', backgroundColor: '#D7A367', '&:hover':{boxShadow: '0px 25px 25px rgba(0, 0, 0, 0.1)'}}}>
                <Grid container height='150px' borderRadius='10px' sx={{
                    backgroundImage: 'url(https://source.unsplash.com/random/?discount)',
                    backgroundSize: 'cover',
                    backgroundPosition: 'center'}}
                />
                <Grid container mx={2}  justifyContent='center'>
                    <Grid container>
                        <Typography variant='body' fontWeight='700' fontSize='45px' color='#black'>Today's Promo</Typography>
                        <Typography variant='body' fontWeight='500' fontSize='20px' color='#black'>Discount 10% on new menu</Typography>
                    </Grid>
                </Grid>
            </Grid>
        </div>
